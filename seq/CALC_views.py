...
def relationship_queries(request, pk): 
    ...
    if fib_query.exists():
        ...
        fib_query_check = None

    else:

        fib_query_check = "Please create fiber"

    if seq_query.exists():

        seq_query_check = None
        
    else:

        seq_query_check = "Please create sequentials"
    ...
    context =  {'projectObj': projectObj, 
                ...
                'fib_query_check': fib_query_check,
                'seq_query_check':seq_query_check,
                }
